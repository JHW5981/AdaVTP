...
def init_model(args, from_weight="none", save_dir='../out', device='cuda'):
    processor = AutoProcessor.from_pretrained(args.first_load_qwen_2_5_vl_weight_path, max_pixels=args.max_pixels, min_pixels=args.min_pixels)
    config = Qwen2_5_VLConfig.from_pretrained(args.first_load_qwen_2_5_vl_weight_path)
    config.text_config.gumbel_temperature = args.gumbel_temperature
    config.text_config.train_drop_rate = args.train_drop_rate
    model = Qwen2_5_VLForConditionalGeneration.from_pretrained(args.first_load_qwen_2_5_vl_weight_path, config=config)
