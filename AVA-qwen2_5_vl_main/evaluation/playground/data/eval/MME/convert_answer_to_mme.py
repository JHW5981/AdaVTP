...
if __name__ == "__main__":
    ...
    GT = get_gt(
        data_path="/mnt/inaisfs/home/test3/jihuawei/projects/LLaVA-FastV/playground/data/eval/MME/MME_Benchmark_release_version/MME_Benchmark"
    )

    experiment = args.experiment

    result_dir = os.path.join('/mnt/inaisfs/home/test2/163879/workspace/AVA-qwen2_5_vl_main/evaluation/playground/data/eval/MME/eval_tool', 'answers', experiment)
    os.makedirs(result_dir, exist_ok=True)

    answers = [json.loads(line) for line in open(os.path.join('/mnt/inaisfs/home/test2/163879/workspace/AVA-qwen2_5_vl_main/evaluation/playground/data/eval/MME/answers', f'{experiment}.jsonl'))]
