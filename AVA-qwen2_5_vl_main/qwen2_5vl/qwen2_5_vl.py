...
from .vision_encoder import Qwen2_5_VisionTransformerPretrainedModel
from .modeling_utils import Qwen2_5_VLPreTrainedModel, Qwen2RMSNorm
from evaluation.eval_utils import select_hidden_states, select_position_ids, select_causal_mask, select_position_embeddings
...
def eager_attention_forward(
    ...
    **kwargs,
    ...
    if adaptive_keep_mask is None:
        ...
        attn_weights = softmax_with_policy(attn_weights, adaptive_keep_mask).to(query.dtype)
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.training:
            ...
            if inputs_embeds.shape[1] > 1: # 表示是prefill阶段
                ...
                causal_mask_mapping['full_attention'] = select_causal_mask(causal_mask_mapping['full_attention'], adaptive_keep_mask)
                position_embeddings = select_position_embeddings(position_embeddings, adaptive_keep_mask)
...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if isinstance(input_ids, transformers.feature_extraction_utils.BatchFeature):
...
__all__ = ["Qwen2_5_VLForConditionalGeneration", "Qwen2_5_VLModel", "Qwen2_5_VLTextModel"]

if __name__ == "__main__":
    from transformers import AutoProcessor
    from qwen_vl_utils import process_vision_info

    model = Qwen2_5_VLForConditionalGeneration.from_pretrained("/mnt/inaisfs/home/test3/jihuawei/pretrained_weights/Qwen/Qwen2.5-VL-3B-Instruct")
    processor = AutoProcessor.from_pretrained("/mnt/inaisfs/home/test3/jihuawei/pretrained_weights/Qwen/Qwen2.5-VL-3B-Instruct", max_pixels=28 * 28 * 576, min_pixels=28 * 28 * 16)

    model.eval()
    model.to("cuda")
    print("模型加载成功。")
    # model.generate(input_ids=torch.randint(0, 100, (1, 10)))
    ...
    messages = [
        {
            ...
            "content": [
                {
                    "type": "image",
                    "image": "/mnt/inaisfs/home/test3/jihuawei/pretraining_data/liuhaotian/LLaVA-Pretrain/images/00598/005988273.jpg",
                },
